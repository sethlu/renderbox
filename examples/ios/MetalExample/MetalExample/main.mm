...
std::unique_ptr<renderbox::MetalRenderer> renderer;
std::unique_ptr<renderbox::SDLMetalRenderTarget> renderTarget;
...
int main(int argc, char **argv) {
	...
	renderer.reset(new renderbox::MetalRenderer());
    renderTarget.reset(new renderbox::SDLMetalRenderTarget());
